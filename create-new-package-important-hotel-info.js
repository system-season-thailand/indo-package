...
const hotelMessageInfoArray = [
...

    {
        ...
        messageInfo_p3: "حجز ثلاث ليالي او اكثر في غرفة ستاندرد = فري ابجريد الى ستاندر جاردن:",
        messageInfo_p3: "الفري ابجريد صالح للإستخدام الى 28 فبراير فقط - لفترة الحجز من 5 يناير الى 17 مارس",
    },
